...
def run():
    ...
    port = int(os.environ.get("WEB_UI_PORT", 50001))  # Set a default port if not specified
    app.run(host='0.0.0.0', request_handler=NoRequestLoggingWSGIRequestHandler, port=port)  # Change here
